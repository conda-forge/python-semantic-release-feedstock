About python-semantic-release-feedstock
=======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-semantic-release-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-semantic-release-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-semantic-release
# for installing globally
pixi global install python-semantic-release
```
...
It is possible to list all of the versions of `python-semantic-release` available on your platform:
...
```
pixi search python-semantic-release --channel conda-forge
```
